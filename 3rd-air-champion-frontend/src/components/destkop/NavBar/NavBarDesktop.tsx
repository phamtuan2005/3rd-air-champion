      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {isGuestMode ? (
          ...
          >
            ...
            Clean
            {/* Yellow (center) = finished cleanings needing hours logged */}
            {cleanTodoCount > 0 && (
              <span className="absolute -top-4 left-1/2 -translate-x-1/2 min-w-[20px] h-5 px-1 rounded-full bg-yellow-400 text-black text-[10px] font-bold flex items-center justify-center leading-none">
                {cleanTodoCount}
              </span>
            ...
            {cleanUnassignedCount > 0 && (
              <span className="absolute -top-4 right-0 min-w-[18px] h-[18px] px-1 rounded-full bg-rose-500 text-white text-[9px] font-bold flex items-center justify-center leading-none">
                {cleanUnassignedCount}
              </span>
            )}
          </button>
